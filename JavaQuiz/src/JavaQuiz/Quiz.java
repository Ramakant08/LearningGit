...
public class Quiz extends JFrame implements ActionListener {
	...
	Quiz(String username) {
	    ...
	    ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("JavaQuiz/icons/quiz_sign.jpeg"));
		JLabel l1 = new JLabel(i1);
		l1.setBounds(0, 0, 1200, 375);
		add(l1);
		qno= new JLabel("1.");
		qno.setBounds(100,425,40,30);
		qno.setFont(new Font("Tahome", Font.PLAIN, 24));
		add(qno);
		
		question= new JLabel("");
		question.setBounds(150,425,800,30);
		...
		lifeline.setBounds(900,575,200,40);
		...
		submit.setBounds(900,675,200,40);
	...
	public void paint(Graphics g) {
		...
		if(timer > 0) {
			g.drawString(time, 930, 450);
		}else {
			g.drawString("times up !",930,450);
		}
	...
	public void start(int count) {                //setting initial values
    	   qno.setText(""+(count+1)+". ");
    	   ...
    	   opt1.setActionCommand(q[count][3]);
    	   opt4.setLabel(q[count][4]);
    	   opt1.setActionCommand(q[count][4]);
